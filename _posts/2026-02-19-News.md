...
I'm writing a full C2 in Rust. If you've been in this field long enough, I know what you're thinking: again a new C2 like we see from students on LinkedIn, vibe-coded in two hours. But yeeaaah, that's not the case here. We are implementing every major feature to have a C2 working properly for professionals: execute-assembly, malleable profile, SOCKS proxy, evading AI/ML protection, LLVM pass, COFF Loader, use of Crystal Palace. This will define a new generation of C2 if things go well.
